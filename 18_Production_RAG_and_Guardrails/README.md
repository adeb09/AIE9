...
1. Create a branch of your `AIE9` repo to track your changes. Example command: `git checkout -b s18-assignment`
...
6. Make sure to include all of the following on your Homework Submission Form:
    + The GitHub URL to the `18_Production_RAG_and_Guardrails` folder _on your assignment branch (not main)_
...
5. Make sure to include all of the following on your Homework Submission Form:
    + The GitHub URL to the `18_Production_RAG_and_Guardrails` folder _on your assignment branch_
    + The URL to your Loom Video
    + Your Three Lessons Learned/Not Yet Learned
    + The URLs to any social media posts (LinkedIn, X, Discord, etc.) ⬅️ _easy Extra Credit points!_
</details>
